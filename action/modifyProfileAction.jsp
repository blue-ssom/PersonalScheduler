...
%>
        <script>
            alert("비밀번호를 입력해주세요.");
            window.location.href = '../page/modifyProfile.jsp'; // 오류 시에 다시 modifyProfile.jsp로 이동하도록 설정
        </script>
<%
...
%>
            <script>
                window.location.href = '../page/viewProfile.jsp'; // 정보 수정 후 viewProfile.jsp로 이동하도록 설정
            </script>
<%

            }
        } else {
            // 전화번호가 변경되지 않은 경우에만 수정
