...
<%
    ...
    // TO DO 2가지
    if (!Pattern.matches("^.{1,100}$", postText)){
%>
        <script>
...
<%
    }else if(!Pattern.matches("^(?:[01]\\d|2[0-3]):[0-5]\\d$", postTime)){
%>
        <script>
...
<%
    ...
    try {
        ...
        // sql 준비 및 전송
        // 입력된 시간과 내용 추가
        String sql = "INSERT INTO scheduler VALUES (user_idx, creationDate, creationTime, content) VALUES (?, ?, ?, ?)";
